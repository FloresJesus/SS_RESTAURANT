...
<template>
  ...
  <div class="reservation-page">
    ...
    <section ref="heroEl" class="hero" @mousemove="onHeroMouseMove">
      ...
      <div class="hero-glass-card">
        ...
        <div class="hero-content">
          <div class="hero-logo">
            <img src="/logo.png" alt="Restaurante San Salvador" class="logo" />
          </div>
            ...
            <div class="info-card">
              <div class="info-item">
                ...
                <div>
                  ...
                  <p>Lunes-Sabado<br/>10:00 - 16:00</p>
                </div>
              </div>
              <div class="info-item">
              ...
              <div class="info-social">
                <a href="https://wa.me/59167262226" class="social-link" title="WhatsApp">
    ...
    <a
      href="https://wa.me/59167262226?text=Hola!%20Quisiera%20hacer%20una%20reservacion"
      target="_blank"
